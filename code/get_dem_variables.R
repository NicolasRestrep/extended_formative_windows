...
anes5_demog <- anes5 %>%
  ...
  mutate(
    ...
    kidinhouse_1 = ifelse(V560178 == 99, NA, ifelse(V560178 == 0, 0, 1)),
    kidinhouse_2 = ifelse(V580475 == 99, NA, ifelse(V580475 == 0, 0, 1)),
    kidinhouse_3 = ifelse(V600691 == 99, NA, ifelse(V600691 == 0, 0, 1)),
    kidinhouse_4 = kidinhouse_3,
    everkid_1 = ifelse(kidinhouse_1 == 1, 1, NA),
    everkid_2 = ifelse(kidinhouse_2 == 1 | everkid_1 == 1, 1, NA),
    everkid_3 = ifelse(kidinhouse_3 == 1 | everkid_2 == 1, 1, NA),
    everkid_4 = everkid_3,
...
anes7_demog <- anes7 %>% 
  mutate(id = 1:nrow(.), 
         ...
         #early adults
         kidinhouse_1 = ifelse(V720296 == 5, 1, NA),
         kidinhouse_2 = ifelse(V721024 == 1, 1, NA),
         kidinhouse_3 = NA,
         kidinhouse_4 = NA,
         kidinhouse_5 = NA,
         everkid_1 = ifelse(V720296 == 5, 1, NA),
         everkid_2 = ifelse(V721024 == 1, 1, NA),
         everkid_3 = case_when(
...
anes8_demog <- anes8 %>% 
  mutate(id = 1:nrow(.), 
         ...
         nkids_4 = nkids_3,
         everkid_1 = ifelse(nkids_1 > 0, 1, NA),
         everkid_2 = ifelse(nkids_2 > 0, 1, NA),
         everkid_3 = case_when(
           VMP3388 == 1 ~ 1, 
           VMP3388 == 5 ~ 0, 
         ...
         everkid_4 = NA,
         kidinhouse_1 = ifelse(is.na(nkids_1), NA, ifelse(nkids_1 > 0, 1, 0)),
         kidinhouse_2 = ifelse(is.na(nkids_2), NA, ifelse(nkids_2 > 0, 1, 0)),
         kidinhouse_3 = ifelse(is.na(nkids_3), NA, ifelse(nkids_3 > 0, 1, 0)),
         kidinhouse_4 = kidinhouse_3,
         # Sex 
...
anes90_demog <- anes90 %>% 
  mutate(
    ...
    everkid_1 = ifelse(kidinhouse_1 == 1, 1, NA),
    everkid_2 = ifelse(kidinhouse_2 == 1, 1, NA),
    everkid_3 = case_when(
      V924136 %in% c(1,2) ~ 1, 
      V924136 == 5 ~ 0, 
    ...
    across(c(V924137, V924139),
           ~ifelse(V924136 == 5, 0, ifelse(.x %in% c(8,9), NA_real_, .x))),
...
anes9_demog <- anes9 %>%
  ...
  mutate(
    ...
    kidinhouse_4 = ifelse(is.na(nkids_4), NA, ifelse(nkids_4 > 0, 1, 0)),
    everkid_5 = everkid_4,
    kidinhouse_5 = kidinhouse_4,
    across(c(V960048, V960049, V960050, V960051),
           ~ifelse(.x > 5, NA, .x)),
    nkids_6 = V960048 + V960049 + V960050 + V960051,
    kidinhouse_6 = ifelse(is.na(nkids_6), NA, ifelse(nkids_6 > 0, 1, 0)),
    everkid_6 = ifelse(kidinhouse_6 == 1, 1, 0),
    kidinhouse_7 = NA,
    everkid_7 = NA,
    kidinhouse_8 = NA,
    everkid_8 = NA,
...
anes0_demog <- anes0 %>% 
  mutate(
    ...
    everkid_2 = ifelse(everkid_1 == 1, 1, NA),
    everkid_3 = ifelse(everkid_1 == 1, 1, NA),
    everkid_4 = ifelse(everkid_1 == 1, 1, NA),
    everkid_5 = ifelse(everkid_1 == 1, 1, NA),
    nkids_1 = ifelse(
      is.na(everkid_1), NA, ifelse(M001023 == 5, 0, ifelse(M001024 > 15, NA_real_, M001024))
    ), 
    kidinhouse_1 = ifelse(is.na(nkids_1), NA, ifelse(nkids_1 > 0, 1, 0)),
    kidinhouse_2 = NA,
    kidinhouse_3 = NA,
...
anes16_demog <- anes16 %>%
  mutate(
    ...
    everkid_1 = ifelse(kidinhouse_1 == 1, 1, NA),
    everkid_2 = everkid_1,
    everkid_3 = ifelse(kidinhouse_3 == 1, 1, NA),
    everkid_4 = everkid_3,
    # Education 
    ed_1 = case_when(
